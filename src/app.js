...
io.on('connection', (sock) => {
  ...
  **/
  ...
  socket.square = {
    ...
    direction: 0, //default direction identifier for which direction the character is facing from 0 to 7 clockwise
    frame: 0, //which frame of animation we are on in the spritesheet
    frameCount: 0, //default counter for how long to spend on each frame (otherwise would be instant)
